      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
          ...
          <div className="bg-[#d2e5f9] rounded-[2rem] p-8 flex flex-col h-full border-2 border-[#82b8f4] shadow-lg relative z-10">
            ...
            <ul className="space-y-3 mb-10 text-[#4b5563] text-[16px]">
              <li className="flex items-start gap-3"><svg className="w-5 h-5 mt-0.5 text-[#111827] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M5 13l4 4L19 7"></path></svg> <span className="font-extrabold text-[18px] text-[#111827]">All features included in Starter</span></li>
          ...
          <div className="bg-[#111827] text-white rounded-[2rem] p-8 flex flex-col h-full hover:shadow-xl transition-shadow border border-[#1f2937]">
            ...
            <ul className="space-y-3 mb-10 text-gray-300 text-[14px]">
              <li className="flex items-start gap-3"><svg className="w-5 h-5 mt-0.5 text-blue-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M5 13l4 4L19 7"></path></svg> <span className="font-extrabold text-[18px] text-white">All features included in Starter</span></li>
